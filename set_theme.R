...
mytme = theme(
  ...
  axis.title.x=element_text(family="sans", size=16,face="bold", colour="black"),
  axis.title.y=element_text(family="sans", size=16, face="bold",angle=90, colour="black"),
  axis.text.x=element_text(family="sans", size=14, colour="black"),
  axis.text.y=element_text(family="sans", size=14, colour="black"),
